    ...
    <>
      <View className="flex-1 items-center justify-center bg-gray-200 p-8 dark:bg-gray-950">
        ...
        >
          ...
          >
            Your complete collection of Khasi hymns and songs at your
            fingertips.
          </Text>
        </Reanimated.View>
      </View>
      ...
      <View className="absolute bottom-0 left-0 right-0 z-10 flex flex-col gap-y-2 px-2">
        ...
        <Text
          className="text-center text-gray-500 dark:text-muted-foreground"
          size={"md"}
        >
          or
        </Text>
        ...
        <Reanimated.View
          className="mt-2"
          style={{ transform: [{ scale: scaleGuest }] }}
        >
          <Button
            onPress={handleGuest}
