...
export const apostleCreed: SongT = {
  ...
  paragraphs: [
    ...
    },
    {
      ...
      order: 3,
      lines: [
        'Nga ngeit ha U Mynsiem Bakhuid, ka Balang Bakhuid shi tyllup ka pyrthei, ka Jingiasyllok ki riewkhuid, ka jingmap ia ki pop; ka jingmihpat jong ka met, bad ka jingim bymjukut.',
      ],
      type: 'VERSE',
    },
  ],
