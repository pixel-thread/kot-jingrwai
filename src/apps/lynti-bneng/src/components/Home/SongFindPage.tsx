        ...
        <View className="mt-6 px-4">
          <Reanimated.View
            ...
            <View className="mb-3 flex-col items-center gap-y-3">
              <View className="border-secondary-foreground w-full flex-row items-center overflow-hidden rounded-xl border bg-gray-200 px-3 dark:border-gray-600 dark:bg-gray-700">
