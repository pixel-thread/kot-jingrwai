...
export const SEO = {
  ...
  title: `${env.NEXT_PUBLIC_APP_NAME} - Your Ultimate Song Collection App`,
  ...
  // URLs and Domain
  url: env.NEXT_PUBLIC_BASE_URL || "https://localhost:3000",
  canonical: env.NEXT_PUBLIC_BASE_URL || "https://localhost:3000",

  // Images for Social Sharing
  ogImage: `${env.NEXT_PUBLIC_BASE_URL}/assets/og/og-image.png`,
  ogImage2: `${env.NEXT_PUBLIC_BASE_URL}/assets/og/og-image-alt.png`,
  ...
  openGraph: {
    ...
    title: `${env.NEXT_PUBLIC_APP_NAME} - Digital Songbook & Worship Music Collection`,
    description:
    ...
    images: [
      {
        url: `${env.NEXT_PUBLIC_BASE_URL}/assets/og/og-image.png`,
        width: 1200,
        height: 630,
        alt: `${env.NEXT_PUBLIC_APP_NAME} - Digital Songbook`,
      },
      {
        url: `${env.NEXT_PUBLIC_BASE_URL}/assets/og/og-image.png`,
        width: 800,
  ...
  twitter: {
    ...
    creator: "@yourhandle",
    title: `${env.NEXT_PUBLIC_APP_NAME} - Digital Songbook`,
    description:
    ...
    image: `${env.NEXT_PUBLIC_BASE_URL}/assets/og/og-image.png`,
    imageAlt: `${env.NEXT_PUBLIC_APP_NAME} - Digital Songbook Interface`,
  },
  ...
  structuredData: {
    ...
    publisher: {
      ...
      logo: {
        "@type": "ImageObject",
        url: `${env.NEXT_PUBLIC_BASE_URL}/globe.svg`,
      },
    },
  },
  ...
  language: "en",
  alternateLanguages: [
    { hreflang: "en", href: `${env.NEXT_PUBLIC_BASE_URL}/en` },
    { hreflang: "kha", href: `${env.NEXT_PUBLIC_BASE_URL}/kha` },
    { hreflang: "x-default", href: env.NEXT_PUBLIC_BASE_URL },
  ],
  ...
  generatePageSEO: (
    ...
    title: `${pageTitle} | ${env.NEXT_PUBLIC_APP_NAME}`,
...
export const generateSongSEO = (
  ...
  title: `${songTitle} - Song #${songNumber} | ${env.NEXT_PUBLIC_APP_NAME}`,
