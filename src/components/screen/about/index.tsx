        ...
        {contentVisible && (
          <>
            ...
            <ContentSection title="Shaphang Jongngi">
              <View className="p-4">
                <Text className="mb-4 text-gray-700 dark:text-gray-300">
                  Ngi sngewbha ban wallam sha phi ia Ka kot jingrwai, ka digital kot jingrwai ha ki
                  por ba phi mane lane long jingiaseng.
                </Text>
              </View>
            </ContentSection>
            ...
            <ContentSection title="Balei Ngi Shna Ia Kane Ka App">
              <View className="p-4">
                <Text className="mb-4 text-gray-700 dark:text-gray-300">
                  Ngi thaw ia Ka kot jingrwai ban iarap ia kito kiba klet lane kim lah ban rah ia ka
                  kot jingrwai ha por mane lane jingiaseng. Ka app jongngi ka ai ka lad ban ioh
